      ...
      messages: [
        {
          ...
          content: [
            {
              type: 'image_url',
              image_url: { url: `data:${photoType};base64,${photo}` },
            },
            {
              type: 'text',
              text: 'Describe this garden space in 2-3 sentences: its layout, size, existing features, lighting conditions, and any structures. Be specific so an artist can recreate it.',
            },
          ],
        },
      ],
